  ...
  return (
    <div className="flex flex-col w-screen h-screen items-center justify-center">
      ...
      >
        ...
        />
        <circle fill="#1a1a1a" cx="86.238" cy="57.885" r="6.667" />
        <circle fill="#1a1a1a" cx="40.072" cy="57.885" r="6.667" />
        <path
          fill="#1a1a1a"
      ...
      <svg
        ...
        xmlSpace="preserve"
      >
        <ellipse fill="#262626" cx="61.128" cy="19.872" rx="49.25" ry="8.916" />
      </svg>
      <h3 className="text-3xl font-bold mb-4"> Помилка 404</h3>
      <p>Сервер не міг знайти запитану сторінку</p>
      <button
        type="button"
        onClick={() => router.push('/')}
        className="bg-primary-100 hover:bg-primary-200 rounded-lg px-3 py-2 disabled:bg-gray-200 text-lg duration-300 mt-5"
      >
        Додому
      </button>
    </div>
